...
const TryNow = () => {
  return (
    <>
    <div className="_3-JMef1dtqqrZ_nQJ7nkQo">
  <div className="_2lptbvjkyjtC_m8fNEAFQk">
    <div className="_149h_WAl6XNNGWAebyZKEh _3Q9qlbuGoKl-V5hsBl8kTS MceIDuOp_oE7i7G45nnUy">
      Try <span className="U2fLB7rVVldEnYc2UBHgW _2dqn9PHs6g_dl32HtphgHZ"><span className="_2aExLWZu5SRFHmo5isCvoC">Liinks</span>
        <div className="QypgFBYhh1uMDyXIF8L4A"></div>
      </span> now!
      <svg className="uLqrT6O7HuazamXj_oy6s _1K954f7VHrpJcxUTNi_9yh" width="44" height="44" viewBox="0 0 44 44" fill="none">
    ...
    <div className="_38OcQHNQQ3p6RU9v1pX4zQ">
      <div className="_2S_MWl1fCBQ1UmxokijNx9 _262-VJ3cK4lUaCpWy5VcZW">
        <svg className="uLqrT6O7HuazamXj_oy6s" width="20" height="19" viewBox="0 0 20 19" fill="none">
  ...
  <div className="_1WFKJ0r569ExTtB8FuHlgk">
