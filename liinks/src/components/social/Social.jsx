...
const Social = () => {
  return (
    <div className="Z2OK9llMn144Wq7xvEH5f">
      <div className="_3nCpy0QGyLbfi3W1WOGqhV">
        <div className="WhNixIsQGHBLrFZr6SOpg">
          <div className="_3n63Y2i4jLRzEeCfYqwT_U">
            <div className="_149h_WAl6XNNGWAebyZKEh _3Q9qlbuGoKl-V5hsBl8kTS">
              Auto-publish 
              <svg className="uLqrT6O7HuazamXj_oy6s _1K954f7VHrpJcxUTNi_9yh" width="56" height="56" viewBox="0 0 56 56" fill="none">
              ...
              from 
              <span className="U2fLB7rVVldEnYc2UBHgW _2a3WpI94Z8gN4kn10LPhfH">
                <span className="_2aExLWZu5SRFHmo5isCvoC">Instagram</span>
                <div className="QypgFBYhh1uMDyXIF8L4A"></div>
              </span>
            </div>
          </div>
          <div className="_3n63Y2i4jLRzEeCfYqwT_U">
            <div className="_149h_WAl6XNNGWAebyZKEh CzZmJ6hN7S9obBfKd0_ul">
          ...
          <a className="_1JpqDpdb11OTIEYgAz8Vw6 _2bFTsP4fuxDT032gJgpb-A _2QQ_vK-tKcrjTX_xhHPfNB _1FcBEpryJUwkWErcHrlXR_ T_YmFjtNnTLaOXdnGbAc6" href="/i/plans">More features</a>
        </div>
      </div>
      <img src="//d1ym67wyom4bkd.cloudfront.net/assets/bundles/6da2d2ec04844202004d961a8038f3853afd3f0f/graphics/feature-instagram-1.png" className="_2s4OVCFWiX-9nc4Er6RCGa" />
    </div>
  );
};
